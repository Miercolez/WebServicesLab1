...
public class FindMovieByLength implements Spi {

    @Override
    public byte[] handleRequest(Request request) {

        int lengthValue = Integer.parseInt(request.urlParams.get("director"));

        List<Movie> movies = Functions.findMoviesByLength(lengthValue);
        ...
        if (!movies.isEmpty()){
            ...
            jsonStr = "Could not find movie with lenth=" + lengthValue + "\r\n";
        }
