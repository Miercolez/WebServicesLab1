...
public class FindMovieByReleaseYear implements Spi {

    @Override
    public byte[] handleRequest(Request request) {

        int releaseYearValue = Integer.parseInt(request.urlParams.get("director"));

        List<Movie> movies = Functions.findMoviesByYear(releaseYearValue);
        ...
        if (!movies.isEmpty()){
            ...
            jsonStr = "Could not find movie with director=" + releaseYearValue + "\r\n";
        }
