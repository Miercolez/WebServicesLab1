...
public class FindMovieByTitle implements Spi {

    @Override
    public byte[] handleRequest(Request request) {

        String titleValue = request.urlParams.get("title");

        List<Movie> movies = Functions.findMoviesByTitle(titleValue);
        ...
        if (!movies.isEmpty()){
            ...
            jsonStr = "Could not find movie with title=" + titleValue + "\r\n";
        }
